import { ChainId, Token, TokenAmount, Pair, InsufficientInputAmountError } from '../'
import { sortedInsert } from '../utils'

describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    const tokenA = new Token(ChainId.TEN_TESTNET, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(ChainId.TEN_TESTNET, '0x0000000000000000000000000000000000000002', 18)
