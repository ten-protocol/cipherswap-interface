...
import { ChainId, WETH as _WETH, TradeType, Rounding, Token, TokenAmount, Pair, Route, Trade } from '../'
...
const CHAIN_ID = ChainId.TEN_TESTNET
const WETH = _WETH[ChainId.TEN_TESTNET]
